...
const workpaperStorage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    try { fs.mkdirSync(entityDir, { recursive: true }); } catch {}
    cb(null, entityDir);
  },
...
app.post('/api/entities/:eid/files', auth, requireRole('Admin','Accountant'), workpaperUpload.array('files', 20), (req, res) => {
