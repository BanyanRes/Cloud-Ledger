...
const BALANCES = { '11010': 415000, '13000': 8200, '17001': 11760052.36, '23375': -202420.88,
                   ...
                   '30200': -11760052.36, '41500': 90000, '52200': 4300, '60100': 12.5 };
...
ok(r.count === 5, 'zero-balance and non-reconcilable kinds dropped — count ' + r.count);
...
ok(rs.skipped_shell_capital === 2, 'skipped_shell_capital reports both — got ' + rs.skipped_shell_capital);
