...
const S = {
  ...
  td: { padding: '10px 14px', borderBottom: '1px solid '+T.borderLight, fontSize: 13, lineHeight: 1.4, verticalAlign: 'middle', height: 42, boxSizing: 'border-box', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
