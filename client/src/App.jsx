...
const S = {
  ...
  td: { padding: '10px 14px', borderBottom: '1px solid '+T.borderLight, fontSize: 13, lineHeight: 1.4, verticalAlign: 'middle' },
  tdR: { padding: '10px 14px', borderBottom: '1px solid '+T.borderLight, textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 13, lineHeight: 1.4, verticalAlign: 'middle' },
  tdC: { padding: '10px 14px', borderBottom: '1px solid '+T.borderLight, textAlign: 'center', fontSize: 13, lineHeight: 1.4, verticalAlign: 'middle' },
  tdBold: { padding: '10px 14px', borderBottom: '2px solid '+T.border, color: T.textBright, fontWeight: 700, fontVariantNumeric: 'tabular-nums', fontSize: 13, lineHeight: 1.4, verticalAlign: 'middle' },
...
function TrialBalance({entityId,entityName,asOf,setAsOf}){
  ...
  return(<div><div style={S.card}><div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:16}}>
    ...
    <table style={{...S.table,tableLayout:'fixed',width:'100%'}}>
      ...
      <tbody>{rows.map(r=><tr key={r.code}><td style={{...S.td,fontWeight:600,color:T.textBright}}>{r.code}</td><td style={{...S.td,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}} title={r.name}>{r.name}</td><td style={S.td}><span style={S.tag(r.type)}>{r.type}</span></td>
