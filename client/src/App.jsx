...
function Requisitions({entityId,entityName,canEdit=true,reqState,setReqState}){
  ...
  useEffect(()=>{setDraft(null);setSeedSource(undefined);setDraftMsg('');setDraftErr('');setActivePhase('');setNewPhase('');setDraftList([]);setFinalizedList([]);setFtRows([]);setFtAsOf('');setFtErr('');setAddingPhase(false);setApErr('');setDraftLoaded(false);loadDraft('');// eslint-disable-next-line
  },[entityId]);
